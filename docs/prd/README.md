...
| 08 | 前端页面规划 | [08-frontend-pages-overview.md](08-frontend-pages-overview.md) | 页面地图、页面职责、模块映射、页面级 PRD 索引 |
...
- 页面与原型评审：先读 [前端页面规划](08-frontend-pages-overview.md)，再进入 `pages/` 和 `prototypes/`。
