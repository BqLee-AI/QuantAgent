...
| 组件与 MVVM | `src/features/**/components/**`、`src/shared/ui/**`、`src/app/components/**` | `components-and-mvvm.md` | 组件是否按 feature/shared 边界放置；props 是否稳定；复杂状态、请求、权限和 JSX 是否被拆分；目录是否按职责分组 |
